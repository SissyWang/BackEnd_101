...
if valid_number?(loan_amount)
  ...
  puts "Hm, this is not a valid number"
end
end
...
#puts("So, your monthly interest rate is #{result1}, and the loan duration in month is #{result2}.")

monthly_payment = loan_amount.to_f * (monthly_rate.to_f/(1-(1 + monthly_rate.to_f) ** -duration_month.to_i))
